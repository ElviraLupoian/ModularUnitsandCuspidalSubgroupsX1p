...
P := [ 97, 139, 307,449, 613, 757,769,829,977, 991 ];
CC := [[-1,4],[7,23],  [11,51], [13,-56], [2,51], [-1, 63], [-19, 32], [31, -69], [997, 854], [59, 165] ];
M := [] ;
...
n := Integers() ! n ;
c := CC[i];
C4 := sub< CS | n11*D1, n11*D3, c[1]*D2 + c[2]*D4, D4>;
C5 := sub< CS | n11*D1>;
C6 := sub< CS | n11*D3>;
C7 := sub< CS | c[1]*D2 + c[2]*D4>;
C8 := sub< CS | D4>;
